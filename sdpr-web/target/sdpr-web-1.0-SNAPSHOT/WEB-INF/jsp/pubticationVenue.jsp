...
<div class="list">
    <div class="rj">
        ...
        <%--<c:forEach items="${journalList }" var="journal">--%>
            <%--<a href="${pageContext.request.contextPath }/article/searchByArticle.action?publisher=${journal }">--%>
    ...
    <div class="rc">
        ...
        <%--<c:forEach items="${conferenceList }" var="conference">--%>
            <%--<a href="${pageContext.request.contextPath }/article/searchByArticle.action?publisher=${conference }">--%>
